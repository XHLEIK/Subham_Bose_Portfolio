create a games section what i play during my free time in the beyound code page using ChromaGrid component
one for mobile games
1. FC mobile
2. Clash of clans
3. BGMI
4. eFootball
...
5. Halo Infinite
i have added the games images in public/games folder
usage
