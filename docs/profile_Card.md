after "welcome to my portfolio" when scrolling down a bit the profile card will display will my pic in public folder profile.webp
it will be either left or right aligned with my name that "i am Subham Bose Aspiring Software Engineer with hands-on experience in Web, Backend & System Design"
usage
...
<ProfileCard
  ...
  showUserInfo
  enableMobileTilt
  behindGlowColor="hsla(168, 100%, 70%, 0.6)"
  customInnerGradient="linear-gradient(145deg,hsla(168, 40%, 45%, 0.55) 0%,hsla(279, 60%, 70%, 0.27) 100%)"
/>
code
...
you can add some of your creativity