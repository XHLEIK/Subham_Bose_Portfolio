under the education section add work experience section usin PixelCard component
with the informations
Act as a senior frontend engineer.

Task:
Build a WORK EXPERIENCE section for the About page using the Pixel Card component.

Structure:
- Two subsections:
  1) Full-Time Experience
  2) Internships
- Each role displayed as an individual Pixel Card.
- Cards arranged in a clean vertical stack with subtle hover interaction.
- Dark theme compatible.

Card Design Rules:you can add your own customizations
- Clear hierarchy:
  - Role Title
  - Company Name
  - Date Range
  - Location (On-Site / Hybrid / Online)
- Bullet-style responsibilities only
- No filler text, no generic descriptions
- Space reserved for Offer Letter / Certificate link button (even if not available yet)
...
Location: Arunachal Pradesh (On-Site)

Responsibilities (generate professional but concise points):
...
Action Area:
- Offer Letter Button (active):
https://www.canva.com/design/DAG-tONseRY/10-a4iTLJxZvfBTdxKWVkw/view?utm_content=DAG-tONseRY&utm_campaign=designshare&utm_medium=link2&utm_source=uniquelinks&utlId=hc43c1c442a
...
Action Area:
- Offer Letter Button (active):
  https://www.canva.com/design/DAG3K59X0Jc/w-eNVW4u4ZbhiNqXIp3Rpw/view?utlId=h074186c3c4
...
Action Area:
- Certificate Button - https://www.canva.com/design/DAG3KZEWkLE/_m_6lJMwY-OFKI4MoNN-Sw/view?utlId=hcf8f144ce5
