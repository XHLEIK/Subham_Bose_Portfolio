create a footer using Laser_Flow animation for all the pages make it beautiful and with all necessary information for footer and with copyright and all other 
usage
