use the dock component instead of the top nav bar for the mobile view in the bottom where currently the side bar for contact is remove the bottom contact bar and replace it with the dock component to navigate to pages
and add a hamburger collapsable side bar only for the mobile view with all the informations which are available in the id card component in the desktop and tablet view
usage
...
take as much time as you need but complete all the tasks 